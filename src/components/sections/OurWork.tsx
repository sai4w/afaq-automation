    ...
    <section id="work" className="bg-background">
      <div className="container px-4 md:px-6">
        <Card className="text-center shadow-lg">
          <CardHeader>
            <CardTitle className="text-3xl font-bold font-headline tracking-tighter sm:text-5xl text-primary">{t.ourWorkTitle}</CardTitle>
          ...
          <CardContent>
            <p className="mb-6">{t.ourWorkDesc}</p>
