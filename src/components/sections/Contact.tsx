      ...
      <div className="container px-4 md:px-6">
        <div className="flex flex-col items-center justify-center space-y-4 text-center">
          <div className="space-y-2">
            <h2 className="text-3xl font-bold font-headline tracking-tighter sm:text-5xl text-primary">{t.contactTitle}</h2>
        ...
        <div className="mx-auto mt-12 max-w-5xl grid grid-cols-1 md:grid-cols-2 gap-8">
          <Card className="shadow-lg">
            <CardHeader>
              <CardTitle>{t.contactFormMessage}</CardTitle>
            </CardHeader>
            <CardContent>
              <form className="space-y-4">
                <Input type="text" placeholder={t.contactFormName} />
                <Input type="email" placeholder={t.contactFormEmail} />
                <Textarea placeholder={t.contactFormMessage} />
                <Button type="submit" className="w-full bg-accent text-accent-foreground hover:bg-accent/90">{t.sendMessage}</Button>
              </form>
            </CardContent>
          </Card>
          <div className="flex flex-col justify-center space-y-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="font-semibold">{t.contactWhatsApp}</h3>
